...
My research indicates that these warnings are [harmless](https://en.wikipedia.org/wiki/Mostly_Harmless). I expect Apple to fix them in future versions of Xcode and iOS.
